  ...
  return (
    <section>
      <div className="container pt-12 pb-20">
        ...
        className='text-2xl uppercase font-bold pb-10 text-left'> Our Menu</motion.h1>
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6'>
          {
            MenuData.map((menu)=>(
              ...
              className='bg-white rounded-3xl px-4 py-2
               shadow-[0_0_22px_0_rgba(0,0,0,0.15)] flex flex-row justify-around items-center gap-3'>
                      <img 
                      src={menu.img}
                      alt=""
