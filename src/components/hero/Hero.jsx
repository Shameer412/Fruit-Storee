               ...
               <div className='flex flex-col justify-center py-14 md:py-0 relative z-10'>
                <div className='text-center md:text-left space-y-6 lg:max-w-[400px]'>
                    ...
                    <motion.p 
                     ...
                     initial="hidden"
                     animate="visible"
                    className='text-2xl tracking-wide'>Order Now For Fresh and Healthy Life</motion.p>
                    <motion.p 
                    //  variants={FadeRight(1.2)}
                    //  initial="hidden"
                    //  animate="visible"
                    className='text-gray-400'>Healthy and yummy food for freah morning
                        breakfast.Eat daily for good health and mind <br/>
                        Order now and get 35% off on your 1st order
                    </motion.p>
                    {/* Button section */}
                    <motion.div  
